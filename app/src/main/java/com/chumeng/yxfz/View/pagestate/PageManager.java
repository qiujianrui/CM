package com.chumeng.yxfz.View.pagestate;
...
{
    private OnPageManagerOnClick mOnPageManagerOnClick;

    public void setOnPageManagerOnClick(OnPageManagerOnClick onPageManagerOnClick) {
        mOnPageManagerOnClick = onPageManagerOnClick;
    }
        ...
        pageLayout.getRetryView().setOnClickListener(new View.OnClickListener() {
           ...
           public void onClick(View v) {
               if(finalListener !=null){
                ...
                if (mOnPageManagerOnClick!=null){
                   mOnPageManagerOnClick.onRetryClick();
                }
           }
       });
