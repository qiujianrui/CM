...
import com.lzy.imagepicker.ImageData;
...
public class ImageGridActivity extends ImageBaseActivity implements ImageDataSource.OnImagesLoadedListener, ImageGridAdapter.OnImageItemClickListener, ImagePicker.OnImageSelectedListener, View.OnClickListener {
    ...
    public void onImageItemClick(View view, ImageItem imageItem, int position) {
        ...
        if (imagePicker.isMultiMode()) {
            ...
            /**Intent数据传递过大,采用本地传递数据*/
            intent.putExtra("item",true);
            ImageData.setmData(imagePicker.getCurrentImageFolderItems());
...
//        Log.d("jere","requestCode=="+requestCode+"resultCode=="+resultCode+"=onActivityResult=="+data);
            if (data != null) {
                //兼容Android 7.0拍照处理
                if (Build.VERSION.SDK_INT >=Build.VERSION_CODES.N&&resultCode == RESULT_OK && requestCode == ImagePicker.REQUEST_CODE_TAKE){
